...
#+begin_src emacs-lisp
  ...
  (use-package corfu
    ...
    (global-corfu-mode)
    :custom
    ;; (corfu-cycle t) ;; Allows cycling through candidates with TAB (and shift-TAB)
  ...
  (use-package cape
    ...
    :after corfu
    :init
    ;; Add various completion sources to the default completion-at-point-functions
    (add-to-list 'completion-at-point-functions #'cape-file)
    (add-to-list 'completion-at-point-functions #'cape-dabbrev)
    (add-to-list 'completion-at-point-functions #'cape-elisp-block)
    ;; More cape-* functions can be added here
    )
