...
#+begin_src emacs-lisp
  ...
  ;; ;; THE CODE BELOW CAN POTETIALLY BREAK SOMETHING. IF SO, THEN UNCOMMENT THE
  ;; ;; CODE ABOVE. AND COMMENT THE CODE BELOW.
  ;; (setq auto-save-file-name-transforms
  ;;     `((".*" ,(concat user-emacs-directory "auto-saves/\\1") t)))
  ;; (add-hook 'eshell-mode-hook
  ;;         (lambda ()
  ;;           (setq buffer-file-name (expand-file-name
  ;;                                   (concat "eshell-auto-save-"
  ;;                                           (md5 (buffer-name)))
  ...
  (use-package docker
    ...
    (add-hook 'docker-image-mode-hook
              (lambda ()
                ...
                (evil-define-key 'normal docker-image-mode-map (kbd "D") 'docker-image-rm)
                (evil-define-key 'visual docker-image-mode-map (kbd "m") 'my-tablist-mark-visual)
                ;; (evil-define-key 'visual-line docker-image-mode-map (kbd "m") 'my-tablist-mark-visual-lines)
                (evil-define-key 'visual docker-image-mode-map (kbd "D") 'docker-image-rm))))
