...
#+begin_src emacs-lisp
  ...
  (defun my-tab-name-format-function (tab i)
    (defface my-active-tab-face
      ...
      '((t :background "#3c3836" :foreground "#fbf1c7"))  ;; #373c42 - previous background color
    ...
    ;;   '((t :background "#1d1f21" :foreground "#5B6268")) ;; #21242b - previous background color
      '((t :background "#1d2021" :foreground "#a89984")) ;; #21242b - previous background color
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'evil
    (define-key evil-normal-state-map (kbd "M-e") 'open-eshell-in-current-directory-popper))
...
#+begin_src emacs-lisp
  ...
  (defun my-popper-toggle-and-resize ()
    "Toggle the Popper window and resize it to one-third of the frame height."
    (interactive)
    (popper-toggle)
    (enlarge-window (- (floor (* 0.33 (frame-height))) (window-height))))

  (with-eval-after-load 'evil
    (define-key evil-normal-state-map (kbd "M-f") 'my-popper-toggle-and-resize))
