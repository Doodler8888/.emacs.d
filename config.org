...
#+begin_src emacs-lisp
  ...
  (defun buffer-displayed-in-window-p (buffer)
...
#+begin_src emacs-lisp
  ...
  ;; (defun my/flymake-yamllint-init ()
  ;;   (let* ((temp-file (flymake-proc-create-temp-inplace (buffer-file-name) "yamllint"))
  ;;          (local-file (file-relative-name temp-file (file-name-directory buffer-file-name))))
  ;;     (list "yamllint" (list "-f" "parsable" local-file))))

  ;; (defun my/flymake-yamllint-setup ()
  ;;   (add-hook 'yaml-ts-mode-hook
  ;;             (lambda ()
  ;;               (add-to-list 'flymake-proc-allowed-file-name-masks
  ;;                            '("\\.ya?ml\\'" my/flymake-yamllint-init))
  ;;               (flymake-mode 1))))

  ;; (my/flymake-yamllint-setup)
