...
#+begin_src emacs-lisp
  ...
  (defun my-evil-insert-state-minibuffer-setup ()
    ...
    (define-key evil-insert-state-local-map (kbd "C-a") 'ivy-partial-or-done))
...
#+begin_src emacs-lisp
  ...
  (defun my/eshell-setup ()
    ...
    (setq shell-file-name "/bin/zsh") ; Set your preferred shell if needed
    (setenv "PATH" "/home/wurfkreuz/.dotfiles/scripts/python/.venv/bin:$PATH"))
