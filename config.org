# 'P' doesn't work
# g; doesn't work
# Unbind M-j and M-k coming from evil-org
...
;; (use-package emacs-undo-fu-session
;;   :vc (:url "https://codeberg.org/ideasman42/emacs-undo-fu-session"
;;        :rev :newest))

;; (add-to-list 'load-path (expand-file-name "emacs-undo-fu-session" user-emacs-directory))
...
(with-eval-after-load 'evil-org
  ;; Remove the default Evil Org bindings for M-j and M-k
  (evil-define-key '(normal insert) evil-org-mode-map (kbd "M-j") nil)
  (evil-define-key '(normal insert) evil-org-mode-map (kbd "M-k") nil)

  ;; Set your custom bindings
  (evil-define-key '(normal insert) evil-org-mode-map (kbd "M-j") 'my-restore-window-configuration)
  (evil-define-key '(normal insert) evil-org-mode-map (kbd "M-k") 'my-eshell-fullscreen))
...
;; (org-defkey org-mode-map "\M-j"    'org-metadown)
;; (org-defkey org-mode-map "\M-k"    'org-metaup)  
