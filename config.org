...
#+begin_src emacs-lisp
  ...
  ;;   "Run `counsel-fzf` from the user's home directory."
  ;;   (interactive)
  ;;   (let ((default-directory "~/"))
  ;;     (counsel-fzf)))

  ;; (defun counsel-fzf-root ()
  ;;   "Run `counsel-fzf` from the root directory."
  ;;   (interactive)
  ;;   (let ((default-directory "/"))
  ;;     (counsel-fzf)))
...
#+begin_src emacs-lisp
  ...
  (use-package lsp-mode
    :commands lsp
    :hook ((go-mode . lsp)
           (clojure-mode . lsp)) ; Automatically start lsp-mode in go-mode and clojure-mode buffers
    :init
    (setq lsp-lens-enable nil)
          ;; lsp-ui-sideline-enable nil ; Ensure lsp-ui-sideline is disabled (if lsp-ui is used)
          ;; lsp-ui-doc-enable nil ; Ensure lsp-ui-doc is disabled (if lsp-ui is used)
          ;; lsp-modeline-diagnostics-enable nil ; Disable diagnostics in the modeline
          ;; lsp-modeline-code-actions-enable nil) ; Disable code actions in the modeline
    :config
