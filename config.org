...
#+begin_src emacs-lisp
  ...
  (defun my-enable-corfu-in-eshell ()
    ...
    (setq-local completion-at-point-functions
                (list #'cape-file
                      #'cape-dabbrev  ;; Dynamic abbreviations from buffer
                      #'cape-keyword  ;; Keyword completion, if relevant
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'evil
    ...
    (define-key evil-insert-state-map (kbd "M-o h") 'insert-path-from-ivy-fzf-home)
    (define-key evil-insert-state-map (kbd "M-o c") 'insert-path-from-ivy-fzf-project)
    (define-key evil-insert-state-map (kbd "M-o r") 'insert-path-from-ivy-fzf-root))
