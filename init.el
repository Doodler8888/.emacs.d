...
(custom-set-variables
 ...
 '(package-selected-packages
   '(all-the-icons-dired avy cape cider circe clojure-ts-mode corfu daemons docker
                         ...
                         marginalia mentor meow orderless org-bullets
                         org-download org-drill popper pyvenv raku-mode shackle
                         sudo-edit swiper terraform-mode toc-org transpose-frame
                         treesit-auto undo-tree vertico vterm wgrep yaml-mode
                         yasnippet zoxide))
